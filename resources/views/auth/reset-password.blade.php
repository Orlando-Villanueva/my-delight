            ...
            <form method="POST" action="{{ route('password.update') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <input 
                        ...
                        required
                        readonly
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all bg-gray-50 text-gray-600 {{ $errors->has('email') ? 'border-red-300 focus:ring-red-500' : '' }}"
                    />
                    @if($errors->has('email'))
                ...
                <div>
                    ...
                    @endif
                    <p class="mt-1 text-sm text-gray-500">Use 8+ characters with a mix of letters, numbers & symbols</p>
                </div>
