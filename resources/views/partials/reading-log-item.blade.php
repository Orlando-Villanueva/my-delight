        ...
        <div class="flex-1">
            ...
            <div class="flex items-center space-x-4 text-sm text-gray-600 mb-3">
                ...
                <span class="flex items-center">
                    ...
                    @php
                        $daysAgo = $log->date_read->diffInDays(now());
                    @endphp
                    @if($daysAgo === 0)
                        Today
                    @elseif($daysAgo === 1)
            ...
            @if($log->notes_text)
                <details class="mt-3">
                    <summary class="cursor-pointer text-sm font-medium text-blue-600 hover:text-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 rounded px-2 py-1 -mx-2 -my-1">
