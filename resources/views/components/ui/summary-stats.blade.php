    ...
    <div class="p-6 lg:p-4 xl:p-6 h-full flex items-center">
        ...
        <div class="grid grid-cols-2 gap-4 w-full">
            ...
            <div class="flex flex-col items-center text-center">
                ...
                <div class="text-lg font-semibold text-gray-600 dark:text-gray-300 mb-1 leading-[1.5]">
                    {{ $thisWeekDays }}/7
                </div>
                <div class="text-xs font-normal text-gray-500 dark:text-gray-500 leading-[1.5]">This Week</div>
            </div>
            ...
            <div class="flex flex-col items-center text-center">
                ...
                <div class="text-xs font-normal text-gray-500 dark:text-gray-500 leading-[1.5]">This Month</div>
            </div>
            ...
            <div class="flex flex-col items-center text-center">
                ...
                <div class="text-xs font-normal text-gray-500 dark:text-gray-500 leading-[1.5]">Total Chapters</div>
            </div>
            ...
            <div class="flex flex-col items-center text-center">
                ...
                <div class="text-xs font-normal text-gray-500 dark:text-gray-500 leading-[1.5]">Bible Progress</div>
            </div>
        </div>
    </div>
</div>