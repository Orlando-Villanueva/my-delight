...
@php
    $cardClasses = 'bg-white rounded-lg border border-gray-200 hover:shadow-md transition-all duration-200';
    if ($compact) {
        $cardClasses .= ' p-3';
    } else {
        $cardClasses .= ' p-4';
    ...
    <div class="flex items-start justify-between">
        <div class="flex-1 min-w-0">
            ...
            @if($showNotes && $log->notes_text)
                <div class="mt-3 text-sm text-gray-600" x-data="{ expanded: false, needsExpansion: false }" x-init="needsExpansion = $el.querySelector('.notes-content').scrollHeight > 60">
